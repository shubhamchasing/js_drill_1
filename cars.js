/* 
    ...
    PROJECT RESTRICTION: Ensure that you use `module.exports = problem1` and not `module.exports = {problem1}` or the `export` keyword. Modules are to be imported using `require` and not the `import` keyword.
